...
class TaskRepositoryTest extends TestCase
{
    ...
    {
        $this->resource = $this->getMockBuilder(\MageMastery\Todo\Model\ResourceModel\Task::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->taskFactory = $this->getMockBuilder(\MageMastery\Todo\Model\TaskFactory::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->searchResultsFactory = $this->getMockForAbstractClass(
            \MageMastery\Todo\Api\Data\TaskSearchResultInterfaceFactory::class,
            [],
            '',
            false,
            false,
        ...
        $this->taskInterface = $this->getMockForAbstractClass(
            \MageMastery\Todo\Api\Data\TaskInterface::class,
            [],
            '',
            false,
            false,
